...
aikg-ont:evaluatesMaterial
Description: "This relation indicates that an instance belonging to one class in { Metric } evaluates an instance of  Material.  It is inferred from the Evaluate-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'evaluate'." ;
    aikg-ont:Material ;
    owl:inverseOf aikg-ont:materialEvaluatedBy .

aikg-ont:evaluatesMethod
Description: "This relation indicates that an instance belonging to one class in { Metric } evaluates an instance of  Method.  It is inferred from the Evaluate-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'evaluate'." ;
    aikg-ont:Method ;
    owl:inverseOf aikg-ont:methodEvaluatedBy .

aikg-ont:evaluatesMetric
Description: "This relation indicates that an instance belonging to one class in { Metric } evaluates an instance of  Metric.  It is inferred from the Evaluate-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'evaluate'." ;
    aikg-ont:Metric ;
    owl:inverseOf aikg-ont:metricEvaluatedBy .

aikg-ont:evaluatesOtherEntity
Description: "This relation indicates that an instance belonging to one class in { Metric } evaluates an instance of  OtherEntity.  It is inferred from the Evaluate-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'evaluate'." ;
    aikg-ont:OtherEntity ;
    owl:inverseOf aikg-ont:OtherEntityEvaluatedBy .

aikg-ont:evaluatesTask
Description: "This relation indicates that an instance belonging to one class in { Metric } evaluates an instance of  Task.  It is inferred from the Evaluate-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'evaluate'." ;
    aikg-ont:Task ;
    owl:inverseOf aikg-ont:taskEvaluatedBy .

aikg-ont:improvesMethod
Description: "This relation indicates that an instance belonging to one class in { Material, Method, OtherEntity, Task } improves an instance of  Method. It is inferred from all the following predicates extracted by the NLP pipeline: 'improve', 'evolve', 'grown', 'enrich', 'expand', 'augment', 'update', 'change', 'raise', 'increase', 'enhance', 'advance', 'gain'." ;
    aikg-ont:Method ;
    owl:inverseOf aikg-ont:methodImprovedBy .

aikg-ont:improvesMetric
Description: "This relation indicates that an instance belonging to one class in { Method, OtherEntity, Task } improves an instance of  Metric. It is inferred from all the following predicates extracted by the NLP pipeline: 'improve', 'evolve', 'grown', 'enrich', 'expand', 'augment', 'update', 'change', 'raise', 'increase', 'enhance', 'advance', 'gain'." ;
    aikg-ont:Metric ;
    owl:inverseOf aikg-ont:metricImprovedBy .

aikg-ont:improvesTask
Description: "This relation indicates that an instance belonging to one class in { Method, OtherEntity, Task } improves an instance of  Task. It is inferred from all the following predicates extracted by the NLP pipeline: 'improve', 'evolve', 'grown', 'enrich', 'expand', 'augment', 'update', 'change', 'raise', 'increase', 'enhance', 'advance', 'gain'." ;
    aikg-ont:Task ;
    owl:inverseOf aikg-ont:taskImprovedBy .

aikg-ont:includesMaterial
Description: "This relation indicates that an instance belonging to one class in { Material, Method, OtherEntity } includes an instance of  Material.  It is inferred from the Feature-of and Part-of relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'include', 'represent', 'contain', 'comprise', 'comprise', 'cover', 'consider', 'incorporate'. " ;
    aikg-ont:Material ;
    owl:inverseOf aikg-ont:materialIncludedBy .

aikg-ont:includesMethod
Description: "This relation indicates that an instance belonging to one class in { Method, Task } includes an instance of  Method.  It is inferred from the Feature-of and Part-of relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'include', 'represent', 'contain', 'comprise', 'comprise', 'cover', 'consider', 'incorporate'. " ;
    aikg-ont:Method ;
    owl:inverseOf aikg-ont:methodIncludedBy .

aikg-ont:includesOtherEntity
Description: "This relation indicates that an instance belonging to one class in { Material, Method, OtherEntity } includes an instance of  OtherEntity.  It is inferred from the Feature-of and Part-of relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'include', 'represent', 'contain', 'comprise', 'comprise', 'cover', 'consider', 'incorporate'. " ;
    aikg-ont:OtherEntity ;
    owl:inverseOf aikg-ont:OtherEntityIncludedBy .

aikg-ont:includesTask
Description: "This relation indicates that an instance belonging to one class in { Task } includes an instance of  Task.  It is inferred from the Feature-of and Part-of relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'include', 'represent', 'contain', 'comprise', 'comprise', 'cover', 'consider', 'incorporate'. " ;
    aikg-ont:Task ;
    owl:inverseOf aikg-ont:taskIncludedBy .

aikg-ont:predictsMaterial
Description: "This relation indicates that an instance belonging to one class in { Method, OtherEntity, Task } predicts an instance of  Material. It is inferred from all the following predicates extracted by the NLP pipeline: 'predict', 'forecast', 'derive'. " ;
    aikg-ont:Material ;
    owl:inverseOf aikg-ont:materialPredictedBy .

aikg-ont:predictsMetric
Description: "This relation indicates that an instance belonging to one class in { Method, Metric, OtherEntity, Task } predicts an instance of  Metric. It is inferred from all the following predicates extracted by the NLP pipeline: 'predict', 'forecast', 'derive'. " ;
    aikg-ont:Metric ;
    owl:inverseOf aikg-ont:metricPredictedBy .

aikg-ont:predictsOtherEntity
Description: "This relation indicates that an instance belonging to one class in { Method, Metric, OtherEntity, Task } predicts an instance of  OtherEntity. It is inferred from all the following predicates extracted by the NLP pipeline: 'predict', 'forecast', 'derive'. " ;
    aikg-ont:OtherEntity ;
    owl:inverseOf aikg-ont:OtherEntityPredictedBy .

aikg-ont:providesMaterial
Description: "This relation indicates that an instance belonging to one class in { Method, OtherEntity, Task } provides an instance of  Material. It is inferred from all the following predicates extracted by the NLP pipeline: 'provide', 'distribute', 'have', 'offer', 'exhibit', 'achieve', 'yield', 'deliver', 'provide', 'give', 'add', 'produce', 'generate', 'build', 'create', 'design', 'design', 'manufacture', 'establish', 'develop', 'implement', 'deploy', 'make', 'construct', 'realize'" ;
    aikg-ont:Material ;
    owl:inverseOf aikg-ont:materialProvidedBy .

aikg-ont:requiresMaterial
Description: "This relation indicates that an instance belonging to one class in { Method, Task } requires an instance of  Material. It is inferred from all the following predicates extracted by the NLP pipeline: 'require', 'need', 'demand'." ;
    aikg-ont:Material ;
    owl:inverseOf aikg-ont:materialRequiredBy .

aikg-ont:requiresTask
Description: "This relation indicates that an instance belonging to one class in { Method, Task } requires an instance of  Task. It is inferred from all the following predicates extracted by the NLP pipeline: 'require', 'need', 'demand'." ;
    aikg-ont:Task ;
    owl:inverseOf aikg-ont:taskRequiredBy .

aikg-ont:supportsMethod
Description: "This relation indicates that an instance belonging to one class in { Method, OtherEntity, Task } supports an instance of  Method. It is inferred from all the following predicates extracted by the NLP pipeline: 'support', 'underlie', 'enable', 'assist', 'promote', 'help', 'empower', 'facilitate', 'aid', 'foster', 'facilitate', 'allow', 'solve'. " ;
    aikg-ont:Method ;
    owl:inverseOf aikg-ont:methodSupportedBy .

aikg-ont:supportsOtherEntity
Description: "This relation indicates that an instance belonging to one class in { Material, Method, Task } supports an instance of  OtherEntity. It is inferred from all the following predicates extracted by the NLP pipeline: 'support', 'underlie', 'enable', 'assist', 'promote', 'help', 'empower', 'facilitate', 'aid', 'foster', 'facilitate', 'allow', 'solve'. " ;
    aikg-ont:OtherEntity ;
    owl:inverseOf aikg-ont:OtherEntitySupportedBy .

aikg-ont:supportsTask
Description: "This relation indicates that an instance belonging to one class in { Material, Method, Metric, OtherEntity, Task } supports an instance of  Task. It is inferred from all the following predicates extracted by the NLP pipeline: 'support', 'underlie', 'enable', 'assist', 'promote', 'help', 'empower', 'facilitate', 'aid', 'foster', 'facilitate', 'allow', 'solve'. " ;
    aikg-ont:Task ;
    owl:inverseOf aikg-ont:taskSupportedBy .

aikg-ont:usesMaterial
Description: "This relation indicates that an instance belonging to one class in { Method, Task } uses an instance of  Material.  It is inferred from the Used-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'use', 'utilise', 'employ', 'utilize', 'exploit', 'integrate', 'adopt', 'leverage', 'apply', 'involve', 'rely'." ;
    aikg-ont:Material ;
    owl:inverseOf aikg-ont:materialUsedBy .

aikg-ont:usesMethod
Description: "This relation indicates that an instance belonging to one class in { Method, OtherEntity, Task } uses an instance of  Method.  It is inferred from the Used-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'use', 'utilise', 'employ', 'utilize', 'exploit', 'integrate', 'adopt', 'leverage', 'apply', 'involve', 'rely'." ;
    aikg-ont:Method ;
    owl:inverseOf aikg-ont:methodUsedBy .

aikg-ont:usesMetric
Description: "This relation indicates that an instance belonging to one class in { Method, OtherEntity, Task } uses an instance of  Metric.  It is inferred from the Used-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'use', 'utilise', 'employ', 'utilize', 'exploit', 'integrate', 'adopt', 'leverage', 'apply', 'involve', 'rely'." ;
    aikg-ont:Metric ;
    owl:inverseOf aikg-ont:metricUsedBy .

aikg-ont:usesOtherEntity
Description: "This relation indicates that an instance belonging to one class in { Method, Metric, OtherEntity, Task } uses an instance of  OtherEntity.  It is inferred from the Used-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'use', 'utilise', 'employ', 'utilize', 'exploit', 'integrate', 'adopt', 'leverage', 'apply', 'involve', 'rely'." ;
    aikg-ont:OtherEntity ;
    owl:inverseOf aikg-ont:OtherEntityUsedBy .

aikg-ont:usesTask
Description: "This relation indicates that an instance belonging to one class in { Task } uses an instance of  Task.  It is inferred from the Used-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'use', 'utilise', 'employ', 'utilize', 'exploit', 'integrate', 'adopt', 'leverage', 'apply', 'involve', 'rely'." ;
    aikg-ont:Task ;
