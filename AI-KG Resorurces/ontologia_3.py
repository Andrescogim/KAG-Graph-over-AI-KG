...
- evaluatesMaterial: indicates that an instance belonging to one class in { Metric } evaluates an instance of  Material.  It is inferred from the Evaluate-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'evaluate'." ;

- evaluatesMethod: indicates that an instance belonging to one class in { Metric } evaluates an instance of  Method.  It is inferred from the Evaluate-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'evaluate'." ;

- evaluatesMetric: indicates that an instance belonging to one class in { Metric } evaluates an instance of  Metric.  It is inferred from the Evaluate-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'evaluate'." ;

- evaluatesOtherEntity: indicates that an instance belonging to one class in { Metric } evaluates an instance of  OtherEntity.  It is inferred from the Evaluate-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'evaluate'." ;

- evaluatesTask: indicates that an instance belonging to one class in { Metric } evaluates an instance of  Task.  It is inferred from the Evaluate-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'evaluate'." ;

- improvesMethod: indicates that an instance belonging to one class in { Material, Method, OtherEntity, Task } improves an instance of  Method. It is inferred from all the following predicates extracted by the NLP pipeline: 'improve', 'evolve', 'grown', 'enrich', 'expand', 'augment', 'update', 'change', 'raise', 'increase', 'enhance', 'advance', 'gain'." ;

- improvesMetric: indicates that an instance belonging to one class in { Method, OtherEntity, Task } improves an instance of  Metric. It is inferred from all the following predicates extracted by the NLP pipeline: 'improve', 'evolve', 'grown', 'enrich', 'expand', 'augment', 'update', 'change', 'raise', 'increase', 'enhance', 'advance', 'gain'." ;

- improvesTask: indicates that an instance belonging to one class in { Method, OtherEntity, Task } improves an instance of  Task. It is inferred from all the following predicates extracted by the NLP pipeline: 'improve', 'evolve', 'grown', 'enrich', 'expand', 'augment', 'update', 'change', 'raise', 'increase', 'enhance', 'advance', 'gain'." ;

- includesMaterial: indicates that an instance belonging to one class in { Material, Method, OtherEntity } includes an instance of  Material.  It is inferred from the Feature-of and Part-of relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'include', 'represent', 'contain', 'comprise', 'comprise', 'cover', 'consider', 'incorporate'. " ;

- includesMethod: indicates that an instance belonging to one class in { Method, Task } includes an instance of  Method.  It is inferred from the Feature-of and Part-of relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'include', 'represent', 'contain', 'comprise', 'comprise', 'cover', 'consider', 'incorporate'. " ;

- includesOtherEntity: indicates that an instance belonging to one class in { Material, Method, OtherEntity } includes an instance of  OtherEntity.  It is inferred from the Feature-of and Part-of relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'include', 'represent', 'contain', 'comprise', 'comprise', 'cover', 'consider', 'incorporate'. " ;

- includesTask: indicates that an instance belonging to one class in { Task } includes an instance of  Task.  It is inferred from the Feature-of and Part-of relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'include', 'represent', 'contain', 'comprise', 'comprise', 'cover', 'consider', 'incorporate'. " ;

- predictsMaterial: indicates that an instance belonging to one class in { Method, OtherEntity, Task } predicts an instance of  Material. It is inferred from all the following predicates extracted by the NLP pipeline: 'predict', 'forecast', 'derive'. " ;

- predictsMetric: indicates that an instance belonging to one class in { Method, Metric, OtherEntity, Task } predicts an instance of  Metric. It is inferred from all the following predicates extracted by the NLP pipeline: 'predict', 'forecast', 'derive'. " ;

- predictsOtherEntity: indicates that an instance belonging to one class in { Method, Metric, OtherEntity, Task } predicts an instance of  OtherEntity. It is inferred from all the following predicates extracted by the NLP pipeline: 'predict', 'forecast', 'derive'. " ;
...
- requiresMaterial: indicates that an instance belonging to one class in { Method, Task } requires an instance of  Material. It is inferred from all the following predicates extracted by the NLP pipeline: 'require', 'need', 'demand'." ;

- requiresTask: indicates that an instance belonging to one class in { Method, Task } requires an instance of  Task. It is inferred from all the following predicates extracted by the NLP pipeline: 'require', 'need', 'demand'." ;

- supportsMethod: indicates that an instance belonging to one class in { Method, OtherEntity, Task } supports an instance of  Method. It is inferred from all the following predicates extracted by the NLP pipeline: 'support', 'underlie', 'enable', 'assist', 'promote', 'help', 'empower', 'facilitate', 'aid', 'foster', 'facilitate', 'allow', 'solve'. " ;

- supportsOtherEntity: indicates that an instance belonging to one class in { Material, Method, Task } supports an instance of  OtherEntity. It is inferred from all the following predicates extracted by the NLP pipeline: 'support', 'underlie', 'enable', 'assist', 'promote', 'help', 'empower', 'facilitate', 'aid', 'foster', 'facilitate', 'allow', 'solve'. " ;

- supportsTask: indicates that an instance belonging to one class in { Material, Method, Metric, OtherEntity, Task } supports an instance of  Task. It is inferred from all the following predicates extracted by the NLP pipeline: 'support', 'underlie', 'enable', 'assist', 'promote', 'help', 'empower', 'facilitate', 'aid', 'foster', 'facilitate', 'allow', 'solve'. " ;

- usesMaterial: indicates that an instance belonging to one class in { Method, Task } uses an instance of  Material.  It is inferred from the Used-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'use', 'utilise', 'employ', 'utilize', 'exploit', 'integrate', 'adopt', 'leverage', 'apply', 'involve', 'rely'." ;

- usesMethod: indicates that an instance belonging to one class in { Method, OtherEntity, Task } uses an instance of  Method.  It is inferred from the Used-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'use', 'utilise', 'employ', 'utilize', 'exploit', 'integrate', 'adopt', 'leverage', 'apply', 'involve', 'rely'." ;

- usesMetric: indicates that an instance belonging to one class in { Method, OtherEntity, Task } uses an instance of  Metric.  It is inferred from the Used-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'use', 'utilise', 'employ', 'utilize', 'exploit', 'integrate', 'adopt', 'leverage', 'apply', 'involve', 'rely'." ;

- usesOtherEntity: indicates that an instance belonging to one class in { Method, Metric, OtherEntity, Task } uses an instance of  OtherEntity.  It is inferred from the Used-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'use', 'utilise', 'employ', 'utilize', 'exploit', 'integrate', 'adopt', 'leverage', 'apply', 'involve', 'rely'." ;

- usesTask: indicates that an instance belonging to one class in { Task } uses an instance of  Task.  It is inferred from the Used-for relationships extracted by the DyGIE++ classifier and the following predicates extracted by the NLP pipeline: 'use', 'utilise', 'employ', 'utilize', 'exploit', 'integrate', 'adopt', 'leverage', 'apply', 'involve', 'rely'." ;
