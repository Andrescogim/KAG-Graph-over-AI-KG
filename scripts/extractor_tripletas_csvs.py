...
from config.settings.settings_tripletas_1 import CSVS_ABS, CSVS_RELS_ENTIS, MODELO, PROMPT, LLM_OPTIONS, COMENTARIOS
...
def main(csvs, modelo, prompt, opciones_LLM, comentarios):
    """ 
    ...
    for csv in csvs:
        ...
        abstracts = abstracts.head(10) # PARA PRUEBAS
        n_abs += len(abstracts)
...
if __name__ == "__main__":
    main(CSVS_ABS, MODELO, PROMPT, LLM_OPTIONS, COMENTARIOS)